...
var VerprogramacionAdmin = function VerprogramacionAdmin() {
  ...
  var eliminarProgramacion = function eliminarProgramacion(id) {
    ...
    if (resultado.length != 0) {
      console.log(resultado.asignacion);
    }
  };
