  ...
  var eliminarProgramacion = function eliminarProgramacion(id) {
    ...
    if (resultado.length != 0) {
      resultado[0].asignacion.map(function (result) {
        var filtrar = result.idAsignacionesDB;
        console.log(filtrar);
      });
    }
  };
